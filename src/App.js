...
const POSITIONS = [
  {top:'5%',left:'3%'},{top:'8%',left:'68%'},{top:'18%',left:'80%'},
  {top:'72%',left:'78%'},{top:'85%',left:'60%'},{top:'88%',left:'5%'},
  {top:'75%',left:'2%'},{top:'3%',left:'38%'},{top:'48%',left:'82%'},{top:'45%',left:'0%'},
];
const ROTATIONS = [-8,5,-4,7,-6,3,-10,6,-3,8];
const COLORS = ['#c0305a','#a0206a','#d04070','#8b1a3a','#b03060','#c84878','#903050','#d05080','#a82858','#b83868'];
const SIZES = [18,22,20,24,19,21,23,18,22,20];
